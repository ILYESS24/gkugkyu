    ...
    >
      <defs>
        ...
        >
          {hovered && (
            <>
              <stop offset="0%" stopColor="rgb(255 255 255)" /> {/* white */}
              <stop offset="25%" stopColor="rgb(200 200 200)" /> {/* light gray */}
              <stop offset="50%" stopColor="rgb(255 255 255)" /> {/* white */}
              <stop offset="75%" stopColor="rgb(150 150 150)" /> {/* gray */}
              <stop offset="100%" stopColor="rgb(255 255 255)" /> {/* white */}
            </>
          )}
        </linearGradient>
