...
import type { IExecuteFunctions, INodeProperties, IWebhookFunctions } from 'workflow-automation-workflow';
import { NodeOperationError, WAIT_INDEFINITELY } from 'workflow-automation-workflow';
