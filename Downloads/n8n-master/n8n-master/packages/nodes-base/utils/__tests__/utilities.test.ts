...
import type { INode, IExecuteFunctions, INodeExecutionData } from 'workflow-automation-workflow';
import { MYSQL_NODE_TYPE, POSTGRES_NODE_TYPE } from 'workflow-automation-workflow';
