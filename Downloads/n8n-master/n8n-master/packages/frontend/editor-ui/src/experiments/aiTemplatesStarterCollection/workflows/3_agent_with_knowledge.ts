...
export const AGENT_WITH_KNOWLEDGE: WorkflowDataCreate = {
	...
	nodes: [
		...
		},
		{
			...
			type: '@workflow-automation/n8n-nodes-langchain.embeddingsOpenAi',
			typeVersion: 1.2,
			position: [288, 176],
		...
		},
		{
			...
			type: '@workflow-automation/n8n-nodes-langchain.documentDefaultDataLoader',
			typeVersion: 1.1,
			position: [80, -144],
		...
		},
		{
			...
			type: '@workflow-automation/n8n-nodes-langchain.vectorStoreInMemory',
			typeVersion: 1.2,
			position: [-176, -304],
		...
		},
		{
			...
			type: '@workflow-automation/n8n-nodes-langchain.agent',
			typeVersion: 2,
			position: [704, -320],
		...
		},
		{
			...
			type: '@workflow-automation/n8n-nodes-langchain.chatTrigger',
			typeVersion: 1.1,
			position: [480, -320],
		...
		},
		{
			...
			type: '@workflow-automation/n8n-nodes-langchain.lmChatOpenAi',
			typeVersion: 1.2,
			position: [480, -96],
