...
import type { ITaskData, INodeExecutionData, IBinaryData } from 'workflow-automation-workflow';
import { BINARY_ENCODING, OperationalError } from 'workflow-automation-workflow';
