import { CliParser, Logger, ModuleRegistry } from '@workflow-automation/backend-common';
import { CommandMetadata, type CommandEntry } from '@workflow-automation/decorators';
